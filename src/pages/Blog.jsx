...
const Blog = () => {
    return (
        <>
            <h1 className=' mt-5 text-center fw-bold text-dark '>BLOGS</h1>
            <Pdf targetRef={ref} filename="code-example.pdf">
                {({ toPdf }) => <button className='btn btn-success m-4' onClick={toPdf}>Generate Pdf</button>}
            </Pdf>
            <div ref={ref} className='my-5 p-4'>
